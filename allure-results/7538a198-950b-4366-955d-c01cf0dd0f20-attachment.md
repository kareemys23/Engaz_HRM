...
```
Error: locator.click: Error: strict mode violation: locator('.ng-untouched > .custom-date-picker > .date-picker-input-wrapper > #date-picker-undefined > .date-picker-icon > svg') resolved to 2 elements:
    1) <svg width="14" height="14" fill="none" viewBox="0 0 14 14" _ngcontent-ng-c2856063223="" xmlns="http://www.w3.org/2000/svg">…</svg> aka locator('.date-picker-icon > svg').first()
    2) <svg width="14" height="14" fill="none" viewBox="0 0 14 14" _ngcontent-ng-c2856063223="" xmlns="http://www.w3.org/2000/svg">…</svg> aka locator('.ng-untouched.ng-pristine.ng-invalid > .custom-date-picker > .date-picker-input-wrapper > #date-picker-undefined > .date-picker-icon > svg')

Call log:
  - waiting for locator('.ng-untouched > .custom-date-picker > .date-picker-input-wrapper > #date-picker-undefined > .date-picker-icon > svg')
  ...
  - dialog [ref=e312]:
    - generic [ref=e317]:
        ...
        - generic [ref=e335]:
          - generic [ref=e336]:
            ...
            - generic [ref=e342] [cursor=pointer]:
              - img [ref=e344]
              - generic [ref=e346]: Oct 21, 2026 - Oct 24, 2026
            - generic [ref=e348]: 3 Working days.
          - generic [ref=e349]:
            - generic [ref=e350]: Expected Delivery Date *
            - generic [ref=e355] [cursor=pointer]:
              - img [ref=e357]
              - generic [ref=e359]: Select expected delivery date
          - generic [ref=e360]:
      ...
      - generic [ref=e378]:
        ...
        - button "Continue" [disabled] [ref=e380]
```
